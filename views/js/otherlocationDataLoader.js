    ...
    return new Promise((resolve, reject) => {
        ...
        request.onload = () => {
            ...
            if (results.length > 0) {
                results.forEach(result => {
                    if (start_index == 0) {
                        html2 += "<section class='otherlocation-section mt-4 d-block'>" +
                            ...
                            '<ion-icon name="heart" data-locationid="' + result.locationID + '">' +
                            "</ion - icon >" +
                            "</div>" +
                        ...
                        html +=
                            ...
                            '<ion-icon name="heart" data-locationid="' + result.locationID + '"></ion-icon>' +
                            "</div>" +
                            "</div>" +
                            "</section>"
                            ;
                ...
                document.removeEventListener('customFavControlEvent', favControl);

                // Yeni dinleyiciyi ekle
                document.addEventListener('customFavControlEvent', favControl);

                // Event'i dispatch et
                document.dispatchEvent(new CustomEvent('customFavControlEvent'));
