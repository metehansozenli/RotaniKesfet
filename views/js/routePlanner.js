...
// const get_locationCoordinates = () => {
//     return new Promise((resolve, reject) => {
//         const request = new XMLHttpRequest();
//         request.open('GET', '/get_locationCoordinates?locationName=${}');

//         request.onload = () => {
//             if (request.status >= 200 && request.status < 300) {
//                 const locations = JSON.parse(request.responseText);
//                 resolve(locations); // İşlem tamamlandığında Promise'i çöz
//             } else {
//                 reject('İstek başarısız: ' + request.statusText);
//             }
//         };
...
// let data = await get_locationCoordinates();
// let k = 2;
